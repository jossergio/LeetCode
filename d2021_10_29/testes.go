...
func mostrar (grade [][] int) {
	fmt.Println ("Grande antes:")
	imprimirGrade (grade)
	fmt.Println ("Mudanças: ", orangesRotting (grade))
	fmt.Println ("Grade depois:")
	imprimirGrade (grade)
} // mostrar

func main() {
	// var grade [][] int = [][] int {{2, 1, 1}, {1, 1, 0}, {0, 1, 1}}
	// var grade [][] int = [][] int {{2, 1, 1}, {0, 1, 1}, {1, 0, 1}}
	var grade [][] int = [][] int {{0, 2}}
	mostrar (grade)
}
