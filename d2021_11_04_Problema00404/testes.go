...
func main() {
	var arvore *TreeNode = &TreeNode {3, &TreeNode {9, nil, nil}, &TreeNode {20, &TreeNode {15, nil, nil}, &TreeNode {7, nil, nil}}}
	fmt.Println (sumOfLeftLeaves (arvore))
	arvore = &TreeNode {1, nil, nil}
	fmt.Println (sumOfLeftLeaves (arvore))
}
